...
class MaterialWin extends JFrame implements ItemListener {
    ...
    void showPicture(String Cuprum, String paper) {
        ...
        String FileName1 = "src/behavioral/visitor/visitor/picture/" + Cuprum + ".jpg";
        String FileName2 = "src/behavioral/visitor/visitor/picture/" + paper + ".jpg";
